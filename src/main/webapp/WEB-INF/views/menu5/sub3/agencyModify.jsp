						...
						<div class="row">
							...
							<div class="col-md-12">
							    <div class="form-group">
							        ...
							        <textarea class="form-control" name="description" rows="5" placeholder="설명"><c:out value="${agency.description}"/></textarea>
							    </div>
							</div>
							<div class="col-md-12">
							    <div class="form-group">
							    ...
							    <div class="form-group">
							        ...
							        <div class="form-check">
							            <label class="form-check-label">
							                <input class="form-check-input" type="radio" name="radio-useYn" value="Y" <c:if test="${agency.useYn eq 'Y'}">checked</c:if>> 사용
							            </label>
							        </div>
							        <div class="form-check">
							            <label class="form-check-label">
							                <input class="form-check-input" type="radio" name="radio-useYn" value="N" <c:if test="${agency.useYn eq 'N'}">checked</c:if>> 미사용
							            </label>
							        </div>
							    </div>
							</div>												
		        ...
		        <div class="card-body table-border-style">
					<div class="row float-right">
						<div class="col-sm-12 input-group mb-3 w-25">
							<button type="button" id="regDtl" class="btn waves-effect waves-light btn-secondary btn-icon btn-msg-send">그룹 상세 등록</button>
						</div>
					</div>		        
								...
								<c:forEach items="${agencyMathList}" var="agencyMath">
									<tr>
										<td class="text-center">
											<a class='detailModal' href='<c:out value="${agencyMath.matId}"/>'>
												<c:out value="${agencyMath.matId}" />
											</a>											
										</td>
