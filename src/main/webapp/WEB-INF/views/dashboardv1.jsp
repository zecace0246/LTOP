                        ...
                        <ul class="feed-blog pl-0">
                            <li class="active-feed">
                                <div class="feed-user-img">
                                    <img src="/resources/assets/images/user/avatar-4.jpg" class="img-radius " alt="User-Profile-Image">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-auto text-center">
                                        <img src="/resources/assets/images/gallery-grid/img-grd-gal-1.jpg" alt="img" class="img-fluid wid-100">
                                        <h6 class="m-t-15 m-b-0">Old Scooter</h6>
                                        <p class="text-muted m-b-0"><small>PNG-100KB</small></p>
                                    </div>
                                    <div class="col-auto text-center">
                                        <img src="/resources/assets/images/gallery-grid/img-grd-gal-2.jpg" alt="img" class="img-fluid wid-100">
                                        <h6 class="m-t-15 m-b-0">Wall Art</h6>
                                        <p class="text-muted m-b-0"><small>PNG-150KB</small></p>
                                    </div>
                                    <div class="col-auto text-center">
                                        <img src="/resources/assets/images/gallery-grid/img-grd-gal-3.jpg" alt="img" class="img-fluid wid-100">
